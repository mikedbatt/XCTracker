...
export const CATEGORIES = {
  Training: {
    label: 'Training',
    color: BRAND,
    types: ['Easy', 'Moderate', 'Tempo', 'Long Run', 'Intervals', 'Speed', 'Cross Train', 'Weights', 'Recovery', 'Time Trial'],
  },
  Event: {
    label: 'Event',
    color: '#dc2626',
...
export const TYPE_COLORS = {
  Easy: '#4caf50', Moderate: '#26a69a', Tempo: '#ff9800', 'Long Run': '#2196f3',
...
export const SIGNAL_TYPE_COLORS = {
  Easy:          '#84CC16',   // lime
  Moderate:      '#10B981',   // emerald — steady / marathon-pace aerobic
  Tempo:         '#F59E0B',   // amber
...
export const WORKOUT_INTENSITY = {
  Easy: 'easy', Moderate: 'easy', Recovery: 'easy', 'Long Run': 'easy', 'Cross Train': 'easy',
