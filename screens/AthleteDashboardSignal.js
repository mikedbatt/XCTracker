...
export default function AthleteDashboardSignal({ userData: userDataProp, refreshUser, goToJoinScreen }) {
...
const styles = StyleSheet.create({
  ...
  sectionTitle: {
    fontFamily: SIGNAL.font.bodySemi, fontSize: 22, color: SIGNAL.color.indigo,
